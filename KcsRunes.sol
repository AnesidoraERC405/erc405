...
contract KcsRunes is ERC405 {
    address private _feeAddress;
    uint256 private _mintFee;
    uint256 private _mintLimit;

    uint256 private constant _runesTotalSupply= 21000000;
    uint256 private constant _conversionRate = 1000000;
    string private constant _name = "KcsRunes";
    string private constant _tick = "KRUNES";
